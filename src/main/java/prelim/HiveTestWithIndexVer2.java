 ...
 */
public class HiveTestWithIndexVer2
{
  ...
  public static void main(String[] args) throws SQLException
  {
    ...
    switch (workload) {
      ...
      case "Aggregation": {
        ...
        // get plan
        ResultSet planRes = stmt.executeQuery("EXPLAIN SELECT sourceIP, SUM(adRevenue) FROM default__uservisits_uservisits_index__ GROUP BY sourceIP");
        while (planRes.next()) {
          planWriter.println(planRes.getString(1));
        }
