 ...
 */
public class HiveBatchTestWithIndex
{
  ...
  public static void main(String[] args) throws SQLException
  {
    ...
    if (args.length != 5) {
      System.out.println("USAGE: HiveBatchTestWithIndex <workload> <data_size> <batch_num> <index_type> <log_path>");
      System.exit(-1);
    }
    ...
    String inputData = String.format("/data_gen/HiBench/Data/%s/%s/Input", dataSize, batchNum);
    String outputData = String.format("/data_gen/HiBench/Data/%s/%s/Output", dataSize, batchNum);

    File timeTakenFile = new File(logPath + File.separator + applicationName + ".time_with_index_" + indexType + "." + batchNum);
    File planFile = new File(logPath + File.separator + applicationName + ".plan_with_index_" + indexType + "." + batchNum);
    File buildIndexFile = new File(logPath + File.separator + applicationName + ".build_index_time_" + indexType + "." + batchNum);
