...
public class ILPSolver extends AbstractSolver {
  ...
  public ILPSolver(
    ...
    super(
        ...
        useRegression);
    this.rawCostArray =
        new double[sampleDBs.size()][workload.getQueries().size()][configurations.size()];
  ...
  public boolean solve() {
    ...
    //        // build structures
    //        GPDLogger.info(this, String.format(
    //            "Building structures for configuration #%d out of %d.", j + 1,
    // configurations.size()));
    ...
    //
    //        GPDLogger.info(this, String.format(
    //            "Running queries for configuration #%d out of %d.", j + 1,
    // configurations.size()));
    ...
    //        // remove structures
    //        GPDLogger.info(this, String.format(
    //            "Removing structures for configuration #%d out of %d.", j + 1,
    // configurations.size()));
    //        for (Structure s : configuration) {
    //          s.drop(conn);
    //        }
